...
import { PlusCircle, LogIn, User, Users, ShieldAlert, Sparkles, ArrowRight } from 'lucide-react';
...
export const Landing: React.FC<LandingProps> = ({ onCreateRoom, onJoinRoom, error }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 py-12 flex flex-col items-center justify-center min-h-[calc(100vh-80px)]">
      {/* Hero Banner */}
      <motion.div
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel border-primary-500/30 text-xs font-semibold text-primary-400 mb-4 shadow-lg shadow-primary-500/10">
          ...
          <span>Real-time Online Party Game</span>
        </div>
        <h1 className="text-4xl sm:text-6xl font-black tracking-tight mb-4 gradient-text">
          ClueVerse
        </h1>
        <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed">
          Bluff, deduce, and uncover secret words with your friends! Give subtle turn-based clues and vote out the hidden imposters before time runs out.
        </p>
      </motion.div>
